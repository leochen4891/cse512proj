...
public class GeometricUnion {
	private static final String INPUT_FILE = "hdfs://192.168.184.165:54310/union_input.csv";
	private static final String OUTPUT_FILE = "hdfs://192.168.184.165:54310/union_output.csv";

	public static void main(String[] args) {
		JavaSparkContext sc = null;

		try {
			System.out.println("Geometric Union Start!");
			...
			JavaRDD<String> lines1 = sc.textFile(INPUT_FILE);
